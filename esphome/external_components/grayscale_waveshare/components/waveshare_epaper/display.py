...
WaveshareEPaper7P5InV2PGrayExperimental = waveshare_epaper_ns.class_(
    "WaveshareEPaper7P5InV2PGrayExperimental", WaveshareEPaper
)
...
MODELS = {
    ...
    "7.50inv2p-grayexp": ("c", WaveshareEPaper7P5InV2PGrayExperimental),
